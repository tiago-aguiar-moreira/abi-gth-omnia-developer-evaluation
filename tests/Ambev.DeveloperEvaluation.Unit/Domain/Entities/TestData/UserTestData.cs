...
public static class UserTestData
{
    ...
    private static readonly Faker<User> UserFaker = new Faker<User>()
        ...
        .RuleFor(u => (UserStatus)u.Status, f => f.PickRandom(UserStatus.Active, UserStatus.Suspended))
        .RuleFor(u => (UserRole)u.Role, f => f.PickRandom(UserRole.Customer, UserRole.Admin));
