...
public class UserTests
{
    ...
    public void Given_SuspendedUser_When_Activated_Then_StatusShouldBeActive()
    {
        ...
        user.Status = (short)UserStatus.Suspended;

        // Act
        user.Activate();

        // Assert
        Assert.Equal((short)UserStatus.Active, user.Status);
    }
    ...
    public void Given_ActiveUser_When_Suspended_Then_StatusShouldBeSuspended()
    {
        ...
        // Assert
        Assert.Equal((short)UserStatus.Suspended, user.Status);
    }
    ...
    public void Given_InvalidUserData_When_Validated_Then_ShouldReturnInvalid()
    {
        ...
        var user = new User
        {
            ...
            Status = (short)UserStatus.Unknown, // Invalid: cannot be Unknown
            Role = (short)UserRole.None // Invalid: cannot be None
        };
